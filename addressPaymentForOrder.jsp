...
try
{
	...
	ResultSet rs1 = st.executeQuery("select sum(total) from cart where email='"+email+"' and address is NULL "); // address is because that should be not placed already
	while(rs1.next())
	{
	total=rs1.getInt(1);	
	}
...
<div class="right-div">
<h3>Pay online on this Rnt@pay.com</h3>
